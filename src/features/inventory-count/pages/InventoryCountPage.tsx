...
import {
  ...
  XCircle, ShoppingCart, Copy, Trash2, ChevronRight, Eraser,
...
import {
  getRisk, getRowState, formatNum, parseInputValue, inputDisplayValue, computeOrderQty,
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      <InventoryCountHubApprovedSection
        ...
        onOpenSmartOrderModal={openSmartOrderModal}
        onDeclineToReview={handleDeclineToReview}
      ...
      <InventoryCountHubModals
        ...
        onNewCountNameDialogOpenChange={(open) => {
          setNewCountNameDialogOpen(open);
        ...
        onSmartOrderDialogOpenChange={(open) => {
          if (!open) setSmartOrderSession(null);
        }}
        ...
        onCreateSmartOrder={handleCreateSmartOrder}
        smartOrderCreating={smartOrderCreating}
        clearEntriesSessionId={clearEntriesSessionId}
        onClearEntriesOpenChange={(open) => {
          if (!open) setClearEntriesSessionId(null);
        }}
        onConfirmClearEntries={handleClearEntries}
        clearInProgressSessionId={clearInProgressSessionId}
        onClearInProgressOpenChange={(open) => {
          if (!open) setClearInProgressSessionId(null);
        }}
        onConfirmClearInProgressSession={handleClearInProgressSession}
        deleteSessionId={deleteSessionId}
        onDeleteSessionOpenChange={(open) => {
          if (!open) setDeleteSessionId(null);
        }}
        onConfirmDeleteSession={handleDeleteSession}
      />
