-- submit_smart_order: propagate location_id from smart_order_runs to purchase_orders.
-- The column was added in 20260503000004 but the RPC INSERT did not include it.
